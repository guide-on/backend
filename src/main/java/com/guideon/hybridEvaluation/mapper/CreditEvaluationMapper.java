...
public interface CreditEvaluationMapper {
     ...
     */
    CreditEvaluation selectLatestCreditEvaluation(@Param("userId") String userId);
     ...
     */
    int countCreditEvaluationHistory(@Param("userId") String userId);
     ...
     */
    int deleteAllCreditEvaluationByUserId(@Param("userId") String userId);
